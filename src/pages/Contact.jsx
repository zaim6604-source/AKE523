...
const faqs = [
  ...
  { q: "Can I visit your office?", a: "Absolutely! Our office is at Flat No. 13-A, 3rd Floor, United Centre, Shamsabad, Murree Road, Rawalpindi. We're open Monday to Saturday, 9 AM to 6 PM." },
...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const text = `Hi Al Asad International! I'm ${form.name || 'a candidate'}. Phone: ${form.phone || 'N/A'}. Interested in: ${form.country || 'N/A'}. ${form.message ? `Message: ${form.message}` : ''}`;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <FadeUp delay={150}>
              <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-ink/60">Flat No. 13-A, 3rd Floor, United Centre, Shamsabad, Murree Road, Rawalpindi</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a href="tel:0514935225" className="text-sm text-ink/60 hover:text-primary">051-4935225</a>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a href={`https://wa.me/${WA_NUMBER}`} target="_blank" rel="noopener noreferrer" className="text-sm text-cta font-semibold hover:underline">0301-5445751</a>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a href="mailto:info@alasadintl.pk" className="text-sm text-ink/60 hover:text-primary">info@alasadintl.pk</a>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-ink/60">2241/RWP — Government Licensed</div>
                      </div>
                    </div>
                  </div>
                </div>

                {/* Map - OpenStreetMap embed for United Centre, Shamsabad */}
                <div className="rounded-2xl overflow-hidden shadow-lg border border-gray-100 h-64">
                  <iframe
                    title="Al Asad International Location"
                    src="https://www.openstreetmap.org/export/embed.html?bbox=73.0445%2C33.5940%2C73.0548%2C33.6040&amp;layer=mapnik&amp;marker=33.5990%2C73.0497"
                    width="100%"
                    height="100%"
                    style={{ border: 'none' }}
                    loading="lazy"
                ...
                <a
                  href="https://www.openstreetmap.org/?mlat=33.5990&mlon=73.0497&zoom=16"
                  target="_blank"
