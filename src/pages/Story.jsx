        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeUp>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-ink text-center leading-tight max-w-4xl mx-auto">
              The Story Behind{' '}
              <span className="text-primary">Al Asad International</span>
            </h1>
          </FadeUp>
        </div>
      </section>
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-lg border border-gray-100">
              ...
              <div className="rounded-xl overflow-hidden mb-8 shadow-md">
                <SafeImage
                  ...
                  alt="Al Asad International office"
              ...
              <div className="editorial-body space-y-5">
                <p>
                  <strong className="text-ink">Al Asad International</strong> was founded with a single
                  mission: to create dignified, well-paying job opportunities for the hardworking people
                  of Rawalpindi and Punjab. From our office at <strong>Shamsabad, Murree Road,
                  Rawalpindi</strong>, we've built a reputation for honesty, transparency, and results.
                </p>

                <p>
                  Our founder, having himself experienced the challenges of finding legitimate overseas
                  employment, established Al Asad International to bridge the gap between Pakistan's
                  skilled workforce and international employers. What started as a small operation
                  serving local communities has grown into a trusted government-licensed agency placing
                  workers across the Gulf, Europe, and Asia.
                </p>
              </div>
              ...
              <div className="editorial-body space-y-5">
                <p>
                  Today, Al Asad International serves hundreds of workers annually, with a network of
                ...
                <p>
                  Our position at <strong>United Centre, Shamsabad</strong> on Murree Road puts us at
                  the heart of Rawalpindi's commercial district, easily accessible from Islamabad and
                  across Punjab. We pride ourselves on being approachable, transparent, and committed
                  to our workers' wellbeing — even after they've landed their jobs abroad.
                </p>
              </div>
            </div>
          </FadeUp>
