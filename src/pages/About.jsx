      ...
      <section className="hero-gradient pt-16 sm:pt-20 pb-16 sm:pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold font-[Plus Jakarta Sans] text-white mt-3 mb-4 leading-tight">
            Soaring Beyond Borders,<br />One Placement at a Time
          </h1>
          <p className="text-base sm:text-lg text-white/80 max-w-lg mx-auto leading-relaxed">
            From the heart of Peshawar Cantt to the world — the story of Parwaz Recruiting Agency.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              { number: '2325/PWR', label: 'License No.' },
            ].map((s, i) => (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div ref={revealRef} className="reveal">
            <div className="flex items-center gap-3 mb-6">
              <span className="w-12 h-px bg-[#FF3CAC]" />
            ...
            <div className="article-body drop-cap">
              <p>
                <strong>Parwaz Recruiting Agency</strong> was founded with a simple belief: that every worker deserves a fair chance at a better life. Based in <strong>Peshawar Cantt</strong>, we are a government-licensed Overseas Employment Agency (<strong>License 2325/PWR</strong>) dedicated to connecting the skilled and determined workers of Pakistan with reputable employers across the Middle East and Europe.
              </p>
              <p>
                Our journey began on Arbab Road, Peshawar, where we saw the ambition and drive of Pakistani workers seeking opportunities beyond borders. With a deep understanding of both the local community and international labor markets, we built an agency that prioritizes transparency, integrity, and genuine care for every candidate we place.
              </p>
            </div>
            ...
            <div className="article-body">
              <p>
                Today, we have placed thousands of workers across 9 countries, building a reputation as one of the most trusted recruitment agencies in Peshawar and beyond. Our success is measured not just in numbers, but in the stories of workers who have transformed their lives and supported their families through overseas employment.
              </p>
              <p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-start mb-16">
            ...
            <div className="rounded-2xl overflow-hidden shadow-lg">
              <img
                ...
                alt="Parwaz Recruiting Agency office"
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-md">
              <div className="w-12 h-12 rounded-xl bg-[#FF3CAC]/10 flex items-center justify-center text-[#FF3CAC] mb-4">
                <i className="fas fa-map-marker-alt text-xl" />
              </div>
              <h3 className="text-xl font-bold font-[Plus Jakarta Sans] text-[#1A0A1E] mb-2">Visit Our Office</h3>
              <p className="text-base text-[#1A0A1E]/70 leading-relaxed mb-4">
                Room No. C-16, First Floor<br />
                Baby Shopping Center, Arbab Road<br />
                Cantt, Peshawar, KPK
              </p>
              <div className="space-y-2 text-sm text-[#1A0A1E]/60">
                <div className="flex items-center gap-2">
                  <i className="fas fa-phone text-[#FF3CAC] w-4" />
                  <span>091-5271919</span>
                </div>
                <div className="flex items-center gap-2">
                  <i className="fab fa-whatsapp text-[#FF3CAC] w-4" />
                  <span>0333-9319471</span>
                </div>
                <div className="flex items-center gap-2">
                  <i className="fas fa-envelope text-[#FF3CAC] w-4" />
                  <span>parwazoep@gmail.com</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div ref={valuesRef} className="reveal">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                { icon: 'fas fa-certificate', title: 'Government Licensed', desc: 'Registered under License 2325/PWR — fully compliant with all regulations.' },
                ...
                { icon: 'fas fa-users', title: 'Local Roots', desc: 'Based in Peshawar Cantt — we understand the local community and its needs.' },
                { icon: 'fas fa-headset', title: 'Post-Placement Support', desc: 'We stay with you even after you reach your destination.' },
              ].map((v, i) => (
                <div
                  key={i}
                  className="bg-white rounded-2xl p-5 sm:p-6 shadow-md hover:shadow-xl border border-pink-100 transition-all"
                >
                  <div className="w-10 h-10 rounded-xl bg-[#FF3CAC]/10 flex items-center justify-center text-[#FF3CAC] mb-3">
                    <i className={v.icon} />
                  </div>
                  <h3 className="text-base font-bold font-[Plus Jakarta Sans] text-[#1A0A1E] mb-2">{v.title}</h3>
                  <p className="text-sm text-[#1A0A1E]/60 leading-relaxed">{v.desc}</p>
                </div>
              ))}
            </div>
          </div>
