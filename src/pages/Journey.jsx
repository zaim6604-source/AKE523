    ...
    <section className="relative animate-page-enter">
      ...
      <div className="relative h-[40vh] min-h-[300px] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://picsum.photos/seed/afaq-journey/1600/600"
            alt="Your journey starts here"
            className="w-full h-full object-cover"
            onError={(e) => { e.target.style.display = 'none' }}
          />
        </div>
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-primary/30 to-transparent z-[2]" />
        <div className="relative z-10 h-full flex items-center">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 w-full">
            <div className="max-w-2xl">
              <span className="inline-flex items-center gap-2 bg-accent/90 text-white text-xs font-bold px-3 py-1 rounded-full mb-4 backdrop-blur">
        ...
        <div className="max-w-2xl mx-auto px-4">
          <ScrollReveal>
            ...
            <p className="text-white/80 mb-6">
              Start your journey today. Contact us for a free consultation.
            </p>
            <a
