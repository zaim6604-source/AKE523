            ...
            {countries.map((country) => {
              ...
              return (
                <Link
                  ...
                  className="guide-card group rounded-2xl overflow-hidden bg-white border border-blue-100 hover:shadow-xl hover:border-[#0496FF]/20 no-underline"
                >
                  ...
                  <div className="p-5 sm:p-6">
                    ...
                    <h3 className="text-xl font-bold font-[Plus Jakarta Sans] text-[#062A45] group-hover:text-[#0496FF] transition-colors mb-2">
                      {country.name}
                    </h3>
                    <p className="text-sm text-[#062A45]/60 leading-relaxed mb-2">
                      {country.headline}
                    </p>
                    <p className="text-xs text-[#062A45]/50 line-clamp-2">
                      {country.intro}
                    </p>
                    <div className="mt-4 flex items-center gap-1.5 text-sm font-semibold text-[#0496FF] group-hover:gap-2.5 transition-all">
                      Read Guide
