...
export const SERVICES = [
  {
    icon: 'fa-briefcase',
    title: 'Job Placement',
    desc: 'We connect you with verified employers across the Middle East, Europe, and Asia.',
  },
  {
  ...
  },
  {
    ...
    desc: 'Basic language courses for German, Arabic, and other destination languages.',
  },
  {
...
export const PROCESS_STEPS = [
  ...
  },
  {
    ...
    desc: 'Pre-departure briefing, travel arrangements, and ongoing support after you arrive.',
    icon: 'fa-graduation-cap',
  },
]

export const COMPANY = {
  name: 'Afaq Overseas Promoters',
  shortName: 'Afaq',
  license: '2244/PWR',
  phone: '091-2271755',
  whatsapp: '0300-8581500',
  whatsappLink: 'https://wa.me/923008581500',
  email: 'afaqoverseaspromters@gmail.com',
  facebook: 'https://www.facebook.com/p/Afaq-Overseas-promoters-Peshawar-100088445085844/',
  address: 'Shop No. 9, Red Crescent Building, Dabgari Garden, Peshawar, KPK',
  addressQuery: 'Red+Crescent+Building+Dabgari+Garden+Peshawar',
  mapUrl: 'https://www.google.com/maps/search/?api=1&query=Red+Crescent+Building+Dabgari+Garden+Peshawar',
  tagline: 'New Horizons Begin the Day You Apply',
  heroTagline: 'Your trusted gateway to overseas employment — from the heart of Dabgari Garden, Peshawar.',
}

export const STATS = [
  { label: 'Candidates Placed', value: '1000+' },
  { label: 'Partner Employers', value: '80+' },
...
export const FAQS = [
  {
    ...
    a: 'You will need a valid passport (6+ months validity), educational certificates, experience letters (if any), and a clean police record. We guide you through the full list during your visit to our Red Crescent Building office.',
  },
  {
  ...
  },
  {
    ...
    a: 'Our fee structure is transparent with no hidden charges. Please visit our office at Dabgari Garden or contact us for a detailed breakdown based on your chosen destination.',
  },
  {
