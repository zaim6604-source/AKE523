...
const STATS = [
  { icon: 'fa-users', end: 5000, suffix: '+', label: 'Workers Placed', color: 'text-white' },
  { icon: 'fa-globe', end: 8, suffix: '+', label: 'Countries', color: 'text-white' },
  { icon: 'fa-certificate', end: 100, suffix: '%', label: 'Govt. Licensed', color: 'text-white' },
  { icon: 'fa-handshake', end: 98, suffix: '%', label: 'Client Satisfaction', color: 'text-white' },
];
