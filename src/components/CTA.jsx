...
export default function CTA() {
  ...
  return (
    <section className="relative overflow-hidden py-20 md:py-24">
      <div className="absolute inset-0 bg-gradient-to-r from-diver-primary via-diver-primary to-diver-cta" />
      ...
      >
        <h2 className="text-3xl md:text-5xl font-extrabold text-white font-heading mb-4 leading-tight">
          ...
          <span className="text-diver-accent">Let's Get Started.</span>
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="bg-diver-cta hover:bg-diver-cta/90 text-white font-bold text-base px-10 py-4 rounded-full transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 active:scale-95 inline-flex items-center gap-2"
          >
