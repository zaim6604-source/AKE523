...
const FALLBACKS = {
  default:  svgURI(600, 400, '#E10600', 'Barkha'),
  avatar:   svgURI(150, 150, '#1C1C1C', 'Barkha'),
  hero:     svgURI(400, 400, '#E10600', 'Barkha'),
  office:   svgURI(600, 500, '#1C1C1C', 'Barkha'),
  landmark: svgURI(600, 400, '#E10600', 'Barkha'),
};
