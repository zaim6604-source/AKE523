...
const FALLBACKS = {
  default:  svgURI(600, 400, '#E10600', 'PAC'),
  avatar:   svgURI(150, 150, '#1C1C1C', 'PAC'),
  hero:     svgURI(400, 400, '#E10600', 'PAC'),
  office:   svgURI(600, 500, '#1C1C1C', 'PAC'),
  landmark: svgURI(600, 400, '#E10600', 'PAC'),
};
