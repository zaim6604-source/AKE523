...
const destinations = [
  ...
  { label: 'Croatia', href: '#destinations' },
];
...
export default function Footer() {
  ...
  return (
    <footer className="bg-diver-highlight text-white">
      {/* Wave top */}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <a href="#hero" className="flex items-center gap-2 mb-5 group">
              ...
              <div>
                <p className="font-bold text-sm text-white leading-tight">The Sialkot Traders</p>
                <p className="text-diver-accent text-xs font-semibold">MANPOWER RECRUITMENT</p>
              </div>
            </a>
            <p className="text-white/60 text-sm leading-relaxed mb-5">
              Sialkot's trusted overseas manpower recruitment agency — licensed,
              honest, and complete. License 2196/SKT.
            </p>

            <div className="space-y-3 text-sm text-white/70">
              <div className="flex items-start gap-2">
                <i className="fas fa-location-dot text-diver-accent mt-1 flex-shrink-0" />
                <span>11-Kashmir Centre, Kutchery Road, Sialkot</span>
              </div>
              <div className="flex items-center gap-2">
                <i className="fas fa-phone text-diver-accent flex-shrink-0" />
                <a href="tel:0524290391" className="hover:text-white transition-colors">052-4290391</a>
              </div>
              <div className="flex items-center gap-2">
                <i className="fas fa-envelope text-diver-accent flex-shrink-0" />
                <a href="mailto:info@sialkottraders.pk" className="hover:text-white transition-colors">
                  info@sialkottraders.pk
                </a>
              </div>
            </div>
          </div>
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-white/60 hover:text-diver-accent text-sm transition-colors duration-200 flex items-center gap-1.5 group"
                  >
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-diver-cta hover:bg-diver-cta/90 text-white font-semibold text-sm px-5 py-3 rounded-full transition-all duration-300 hover:shadow-lg"
            >
      ...
      <div className="border-t border-white/10">
        <div className="container-pad py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-white/40">
          <p>
            &copy; {year} The Sialkot Traders. All rights reserved.
          </p>
          <p className="flex items-center gap-1">
            License <strong className="text-diver-accent">2196/SKT</strong>
          </p>
        </div>
      </div>
    </footer>
