...
const COUNTRIES = [
  { name: 'Saudi Arabia', flag: '🇸🇦', roles: ['Construction', 'Healthcare', 'Drivers', 'Hospitality'], image: 'https://images.unsplash.com/photo-1590080872588-97eafd845c6e?w=400&q=80' },
  ...
  { name: 'Qatar', flag: '🇶🇦', roles: ['Construction', 'Hospitality', 'Security', 'Technicians'], image: 'https://images.unsplash.com/photo-1624555130581-1d7e5a8a628e?w=400&q=80' },
  ...
  { name: 'Poland', flag: '🇵🇱', roles: ['Manufacturing', 'Logistics', 'Construction', 'Factory'], image: 'https://images.unsplash.com/photo-1568555722080-40b96e04e9c0?w=400&q=80' },
  ...
  { name: 'South Korea', flag: '🇰🇷', roles: ['Manufacturing', 'Construction', 'Technicians', 'Agriculture'], image: 'https://images.unsplash.com/photo-1517154421773-0529f29ea571?w=400&q=80' },
