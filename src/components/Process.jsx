...
const steps = [
  ...
  { icon: 'fa-solid fa-file-lines', label: 'Documents & Visa', desc: 'Submit your documents and we\'ll handle the visa application process for you.', color: '#83C5BE' },
  { icon: 'fa-solid fa-stethoscope', label: 'Medical & Trade Test', desc: 'We coordinate your medical exams and any required trade skill assessments.', color: '#E29578' },
  ...
  { icon: 'fa-solid fa-plane-departure', label: 'Ticketing & Departure', desc: 'We book your flight and ensure you\'re fully prepared for departure.', color: '#006D77' },
];
    ...
    <section id="process" className="relative">
      ...
      <div style={{ backgroundColor: '#83C5BE' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          ...
          <p className="text-center text-base sm:text-lg mb-10 sm:mb-12 max-w-2xl mx-auto text-[#003844]">
            Five simple steps to your next opportunity abroad.
          </p>

          {/* Filmstrip on angled band */}
              ...
              {steps.map((s, i) => (
                ...
                >
                  ...
                  >
                    ...
                    {/* Label */}
                    <h3 className="text-sm sm:text-base font-bold m-0 mb-2 text-white">
                      {s.label}
                    </h3>

                    {/* Description */}
                    <p className="text-xs sm:text-sm leading-relaxed" style={{ color: '#83C5BE' }}>
                      {s.desc}
                    </p>
                  </div>
                </div>
          ...
          {/* Scroll hint */}
          <p className="text-center text-xs sm:text-sm mt-4 font-medium text-[#003844]">
