export default function SectionHeader({ tag, title, sub, light }) {
  return (
    <div className="text-center mb-14">
      ...
      <h2 className={`text-3xl sm:text-4xl font-black leading-tight ${light ? 'text-white' : 'text-[#340710]'}`}>
        {title}
      </h2>
      <div className="w-16 h-1 rounded-full mx-auto mt-4" style={{ background: 'linear-gradient(90deg, var(--color-primary), var(--color-cta))' }} />
      {sub && (
