...
export default function QuickApply() {
  ...
  const handleSubmit = (e) => {
    ...
    const msg = encodeURIComponent(
      `Hello The Sialkot Traders! I want to apply for overseas employment.%0A%0AName: ${name}%0APhone: ${phone}%0AJob Category: ${jobCategory}`
    );
    ...
    <div className="fixed bottom-6 right-6 z-[999]">
      <button
        ...
        className={`w-14 h-14 rounded-full flex items-center justify-center text-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl ${
          open ? 'bg-gray-700 rotate-45' : 'bg-diver-cta'
        }`}
      ...
      >
        <div className="bg-gradient-to-r from-diver-cta to-diver-primary p-4">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-3">
          <input
            ...
            required
            className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-sm outline-none focus:border-diver-cta focus:ring-2 focus:ring-diver-cta/20"
          />
          <input
            type="tel"
          ...
          <select
            ...
            className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-sm outline-none focus:border-diver-cta focus:ring-2 focus:ring-diver-cta/20 appearance-none"
          >
